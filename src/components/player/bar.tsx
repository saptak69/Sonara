...
export function PlayerBar() {
  ...
  return (
    <>
      {/* Mobile Bar */}
      <div className="md:hidden mx-2 relative max-md:bg-surface/95 bg-surface/60 backdrop-blur-3xl rounded-[1.5rem] border border-white/10 shadow-2xl overflow-hidden">
