...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sonara" },
      { name: "description", content: "Sonara is a modern, fast, and cinematic music streaming platform." },
      { name: "keywords", content: "music, streaming, sonara, audio, songs, radio, podcasts" },
      { name: "theme-color", content: "var(--color-bg)" },
      { name: "google-site-verification", content: "YOUR_GOOGLE_VERIFICATION_CODE_HERE" },
      { property: "og:title", content: "Sonara Music" },
      { property: "og:description", content: "Discover and stream millions of tracks instantly with Sonara." },
