...
function AboutPage() {
  ...
  const contactEmail = "saptakmondal69@gmail.com";
  ...
  return (
    <div className="min-h-screen px-4 py-8 sm:px-8 max-w-5xl mx-auto space-y-16 animate-in fade-in duration-300">
      {/* Hero Header */}
      <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.08] via-black/60 to-black/90 p-8 sm:p-12 backdrop-blur-3xl shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/15 border border-accent/30 text-accent text-xs font-semibold tracking-wide uppercase shadow-sm">
            ...
            <p className="text-sm sm:text-base text-muted/90 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2 text-xs text-muted">
              <span className="flex items-center gap-1 px-3 py-1 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="hidden sm:flex flex-col items-center justify-center p-6 rounded-2xl bg-white/[0.03] border border-white/10 shadow-inner">
            <SonaraIcon size={84} />
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          ...
          <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-muted hidden sm:inline-block">
            Independent Builder
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 backdrop-blur-xl space-y-6">
            ...
            <div className="pt-4 border-t border-white/10 space-y-3">
              ...
              <div className="p-3.5 rounded-xl bg-black/40 border border-white/10 text-xs text-fg/85 italic leading-relaxed">
          ...
          <div className="flex flex-col justify-between gap-6 rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-black/60 p-6 sm:p-7 backdrop-blur-xl">
            <div className="space-y-4">
              <div className="size-12 rounded-xl bg-accent/20 border border-accent/40 flex items-center justify-center text-accent shadow-sm">
            ...
            <div className="space-y-3 pt-4 border-t border-white/10">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-fg text-xs font-medium border border-white/10 transition-all active:scale-95"
              >
        ...
        {/* A Small Note */}
        <div className="p-5 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/10 text-xs text-muted leading-relaxed space-y-2">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/10 space-y-2.5">
            <div className="size-9 rounded-lg bg-red-500/10 text-accent flex items-center justify-center">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/10 space-y-3">
            ...
            <ul className="text-xs text-muted/90 space-y-1.5 pl-4 list-disc marker:text-accent">
            ...
            <p className="text-xs text-muted leading-relaxed pt-2 border-t border-white/[0.06]">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/15 text-xs font-semibold text-fg border border-white/15 transition-all shadow-sm shrink-0"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.08] text-xs space-y-1">
              <span className="font-semibold text-fg/90">1. Contact Information</span>
              <p className="text-muted text-[11px]">Your legal name, email address, and company or organization.</p>
            </div>
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.08] text-xs space-y-1">
              <span className="font-semibold text-fg/90">2. Copyrighted Work</span>
              <p className="text-muted text-[11px]">Specific identification and description of the copyrighted material.</p>
            </div>
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.08] text-xs space-y-1">
              <span className="font-semibold text-fg/90">3. Content on Sonara</span>
              <p className="text-muted text-[11px]">Exact track title, artist name, or album as displayed on the platform.</p>
            </div>
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.08] text-xs space-y-1">
              <span className="font-semibold text-fg/90">4. Location & URL</span>
              <p className="text-muted text-[11px]">The specific URL or ID that enables us to locate the material immediately.</p>
            </div>
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.08] text-xs space-y-1">
              <span className="font-semibold text-fg/90">5. Statement of Rights</span>
              <p className="text-muted text-[11px]">A declaration confirming your ownership or authorization to act on behalf of the owner.</p>
            </div>
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.08] text-xs space-y-1">
              <span className="font-semibold text-fg/90">6. Supporting Info</span>
              <p className="text-muted text-[11px]">Any additional documentation or registration details that assist review.</p>
            </div>
          </div>

          <div className="text-xs text-muted/80 pt-2 border-t border-white/[0.06] flex items-center justify-between flex-wrap gap-2">
            <span>We review legitimate notices promptly and take appropriate corrective action where required.</span>
            <span className="text-fg font-mono text-[11px]">{contactEmail}</span>
          </div>
        </div>

        {/* No Ownership Claim & Notice */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/10 space-y-2 text-xs text-muted leading-relaxed">
        ...
        <div className="text-center pt-2">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[11px] text-muted">
