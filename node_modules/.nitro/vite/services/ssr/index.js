...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-B02xgIrI.js");
...
var manifest = {
	"0aa5139c56de2d1d73dee54876bce24d19afac5d63f334e8b49bbbe3708c107d": {
		...
		importer: () => import("./assets/artist-studio-C3YvQ0fV.js")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router--X2oxkDG.js").then((n) => n.t),
